  ...
  useEffect(() => {
    const fetchServices = async () => {
      ...
      try {
        ...
        if (debouncedPriceRange[0] !== null)
          params.append("minPrice", debouncedPriceRange[0]);
        if (debouncedPriceRange[1] !== null)
          params.append("maxPrice", debouncedPriceRange[1]);
        console.log(params);
        const url =
          params.toString().length > 0
            ? `https://skill-development-backend.vercel.app/services?${params.toString()}`
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    width: `${
                      ((priceRange[1] - priceRange[0]) / 100000) * 100
                    }%`,
                  }}
                />
                {children}
